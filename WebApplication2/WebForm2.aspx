...
<div id="leftuzor" style="float:left; overflow:visible; width:150px; height:188px;   positition:relative; margin-left:0px; margin-top:0px; "> <img  src="uzor1 copy.png" /></div>
   ...
   <form id="form1" runat="server">
        ...
        <%--<div id="rightpart">
          ...
          <div id="header">
         <div id="name">
              <div style="font-size:28px; margin-top:17px;"><strong>Интернет-магазин</strong></div><%--font-size:33px;--%>
            <div style="margin-top:15px;"><strong>Модной верхней одежды</strong></div><%--font-size:20px;--%> 
         </div>
        ...
        <div style=" margin-top:10px;"><strong>Торговый центр-маркет "Полет"</strong></div><%--font-size:33px;--%>
            <div style="font-size:20px; margin-top:5px;"><strong>3-й этаж торговая точка 116</strong></div><%--font-size:20px;--%>
         </div>
         <div id="header1">
            
           <strong> Наш адрес:
            <br />г. Иваново, ул. Багаева, 14<br /> 
            Телефон: +7(4932) 38-38-19<br />
            Электронная почта: vladimirsmirnov89@gmail.com<br />
       ...
       Вот так вот
        ...
        <%-- SelectCommand="SELECT * FROM [Thing] WHERE ((color=@color) AND (brand=@brand) AND (size=@size))" --%>
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                ...
                ProviderName="<%$ ConnectionStrings:newConnectionString.ProviderName %>" ><%-- "SELECT * FROM [Thing] WHERE EXISTS (SELECT * FROM Size WHERE  = 'Москва')"--%>
                <SelectParameters> 
